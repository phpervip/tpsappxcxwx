...
wx.navigateTo({
	...
	logout: function () {
       ...
       wx.request({
         url: 'http://82360490.qcloud.la/index.php/Api/User/logoutWX/openid/' + app.globalData.openid,
         data: {},
  ...
  getnum: function (e) {
    ...
    if (parseInt(that.data.phoneNum).toString().length == 11) {
      ...
      return ;
      wx.request({
        url: 'http://82360490.qcloud.la/index.php/Api/Shipper/getCaptcha.html',
  ...
  quick_login_phone: function (e) {
    ...
    if (parseInt(this.data.num).toString().length == 4) {
      ...
      console.log('http://82360490.qcloud.la/index.php/Api/User/validate?phone=' + this.data.phoneNum + "&num=" + this.data.num + "&openid=" + app.globalData.openid);
      wx.request({
        url: 'http://82360490.qcloud.la/index.php/Api/User/validate?phone=' + this.data.phoneNum + "&num=" + this.data.num + "&openid=" + app.globalData.openid,
